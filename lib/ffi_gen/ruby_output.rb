  ...
  class Enum
    def write_ruby(writer)
      ...
      @constants.each do |constant|
        constant[:symbol] = ":#{@generator.to_ruby_downcase constant[:name]}"
      end
  ...
  class StructOrUnion
    def write_ruby(writer)
      @fields.each do |field|
        field[:symbol] = ":#{@generator.to_ruby_downcase field[:name]}"
  ...
  class FunctionOrCallback
    def write_ruby(writer)
      @parameters.each do |parameter|
        ...
        parameter[:ruby_name] = !parameter[:name].empty? ? @generator.to_ruby_downcase(parameter[:name]) : parameter[:type_data][:parameter_name]
