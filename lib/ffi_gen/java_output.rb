class FFIGen
  def generate_java
    writer = Writer.new "    ", " * ", "/**", " */"
    writer.puts "// Generated by ffi_gen. Please do not change this file by hand.", "import java.util.*;", "import com.sun.jna.*;", "import java.lang.reflect.Method;", "", "public interface #{@module_name} extends Library {"
    writer.indent do
      ...
      writer.indent do
        ...
        writer.indent do
          ...
          writer.puts "", "Map<String, Object> options = new HashMap<String, Object>();", "options.put(Library.OPTION_FUNCTION_MAPPER, new MapFunctionMapper(nameMap));", "options.put(Library.OPTION_TYPE_MAPPER, typeMapper);"
